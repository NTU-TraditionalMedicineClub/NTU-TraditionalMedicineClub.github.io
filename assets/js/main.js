...
function openDialog(index)
{
   ...
   if(index === "GueiJhih")
   {
      ...
      description2.innerHTML ="性味辛、甘、溫。歸心、肺、膀胱經。能發汗散寒、溫通經脈、助陽化氣。";
      description3.innerHTML ="為辛溫解表藥，主治風寒感冒、風寒濕痹，及脘腹冷痛、血寒經閉。";
      description4.innerHTML ="作為方劑<b style ='color: #40a5b4'>桂枝湯</b>之君藥，用於一般風寒感冒。";
   }
   else if(index === "MaHuang")
   {
      picture.src ="assets/img/medicine/MaHuang.jpg";
      description1.innerHTML ="麻黃科植物草麻黃、中麻黃或木賊麻黃之乾燥草質莖。";
      description2.innerHTML ="性味辛、微苦、溫。歸肺、膀胱經。發汗能力甚強，亦能宣肺平喘、利水消腫。";
      description3.innerHTML ="為辛溫解表藥，主治風寒感冒、風濕浮腫、胸悶喘咳、哮喘。";
      description4.innerHTML ="作為方劑<b style ='color: #40a5b4'>麻黃湯</b>之君藥，用於風寒感冒。然其發汗力強，表虛自汗、陰虛盜汗及肺腎虛者慎用。";
   }
   else if(index === "ShengJiang")
   {
      picture.src ="assets/img/medicine/ShengJiang.jpg";
      description1.innerHTML ="薑科植物薑之新鮮根莖。";
      description2.innerHTML ="性味辛、溫。歸肺、脾、胃經。能發散風寒，亦有溫中止嘔、溫肺止咳之效。";
      description3.innerHTML ="為辛溫解表藥，主治風寒感冒、胃寒嘔吐、風寒咳嗽。";
   ...
   else if(index === "ChaiHu")
   {
      ...
      description2.innerHTML ="性味苦、辛、微寒。歸肝、膽經。能疏風熱、升陽舉陷，然更常取其疏肝解鬱之效。";
      description3.innerHTML ="為辛涼解表藥，主治感冒發熱、肝鬱氣滯、寒熱往來、胸脅脹痛、子宮脫垂、脫肛。";
      description4.innerHTML ="作為方劑<b style ='color: #40a5b4'>逍遙散</b>之君藥，用於肝脾不調、胸悶憂鬱、消化不良、發熱。";
   }
   else if(index === "BoHe")
   {
      picture.src ="assets/img/medicine/BoHe.jpg";
      description1.innerHTML ="唇形科植物薄荷及同屬近緣植物之乾燥地上部分。";
      description2.innerHTML ="性味辛、涼。歸肺、肝經。能疏散風熱、清利頭目、利咽、透疹、疏肝解鬱。";
      description3.innerHTML ="為辛涼解表藥，主治風熱感冒、頭痛目赤、咽喉腫痛、麻疹風疹、肝鬱氣滯、胸悶脅痛。";
   ...
   else if(index === "GeGen")
   {
      ...
      description4.innerHTML ="作為方劑<b style ='color: #40a5b4'>葛根湯</b>之君藥，處理兼有頭項強痛的外感表證。";
   }
   else if(index === "ShihGao")
   {
      ...
      description3.innerHTML ="為清熱瀉火藥，主治壯熱煩渴、肺熱喘咳、胃火牙痛、瘡瘍潰爛、疹浸淫、水火燙傷。";
      description4.innerHTML ="大寒易傷脾胃，脾胃虛寒及陰虛內熱者忌用。";
   }
   else if(index === "JinYinHua")
   {
      picture.src ="assets/img/medicine/JinYinHua.jpg";
      description1.innerHTML ="忍冬科植物忍冬之花蕾。初開白，而後變黃，故稱金銀。";
      description2.innerHTML ="性味甘、寒。歸肺、心、胃經。能清熱解毒、疏散風熱。";
      description3.innerHTML ="為清熱解毒藥，主治癰腫疔瘡、風熱溫病初起、熱毒血痢。";
      description4.innerHTML ="癰腫疔瘡陽證之要藥，治此證時可單用煎服，或以渣敷於患處。價值高，亦時常與銀翹配伍使用。";
   }
   else if(index === "LianChao")
   {
      ...
      description3.innerHTML ="為清熱解毒藥，主治癰腫瘡毒、溫病初起、熱淋澀痛。「諸痛癢瘡，皆屬於心。」連翹主入心經，能清心火、解瘡毒、散血消結，是為「瘡家聖藥」。";
      description4.innerHTML ="與金銀花組成方劑<b style ='color: #40a5b4'>銀翹散</b>之基礎，治外感風熱。";
   }
   else if(index === "HuangLian")
   {
      ...
      description4.innerHTML ="與黃芩、黃柏合稱「三黃」，分清上中下三焦實火，如方劑<b style ='color: #40a5b4'>黃連解毒湯</b>。然其性大苦大寒，又苦燥傷津，肺胃虛寒及陰虛津傷者慎用。";
   }
   else if(index === "DanPi")
   {
      ...
      description3.innerHTML ="為清熱涼血藥，主治斑疹吐衄、溫邪傷陰、陰虛發熱、血滯經閉、痛經、癰瘍腫毒、腸癰腹痛。";
   ...
   else if(index === "RenShen")
   {
      ...
      description2.innerHTML ="性味甘、微苦、微溫。歸脾、肺、心經。能大補元氣、補脾益肺、生津、安神，補氣效果極佳。";
      description3.innerHTML ="為補氣藥，能治氣津兩傷、氣虛欲脫、脈微欲絕等重危證候，或一切氣虛證候。";
      description4.innerHTML ="出現在<b style ='color: #40a5b4'>四君子湯</b>等補氣方劑，是少數可久服的上等藥材。然而人參惡萊菔子 (蘿蔔籽)，與蘿蔔或茶同服會影響補力。";
   }
   else if(index === "HuangChi")
   {
      picture.src ="assets/img/medicine/HuangChi.jpg";
      description1.innerHTML ="豆科植物蒙古黃耆或膜莢黃耆之乾燥根。";
      description2.innerHTML ="性味甘、微溫。歸脾、肺經。能補氣、利水消腫、托瘡生肌。此外升陽舉陷、益衛固表的功效更是其重要特色。";
      description3.innerHTML ="為補氣藥，主治脾胃氣虛，中氣下陷，表虛自汗，氣虛水濕失運之浮腫、小便不利。";
      description4.innerHTML ="作為方劑<b style ='color: #40a5b4'>玉屏風散</b>之君藥，治療表虛、自汗。其與甘草外表相似，但黃耆纖維較軟，色也較淡。";
   }
   else if(index === "GanTsao")
   {
      picture.src ="assets/img/medicine/GanTsao.jpg";
      description1.innerHTML ="豆科植物甘草、脹果或光果甘草之乾燥根、莖。";
      description2.innerHTML ="性味甘、平。歸心、肺、脾、胃經。能調和藥性、緩急止痛、益氣補中、祛痰止咳。";
      description3.innerHTML ="為補氣藥，主治心氣不足、脘腹四肢攣急作痛。炙甘草 (右下者) 加強了補氣力道，生甘草則偏於清熱，治咽喉腫痛。";
      description4.innerHTML ="在諸多方劑中扮演調和諸藥的角色，然甘草次酸有抗利尿作用，量服易引起水腫問題。甘草含在嘴中有甘味，此亦是與黃耆區分之法。";
   }
   else if(index === "ShouDi")
   {
      ...
      description3.innerHTML ="為補血藥，主治血虛眩暈、心悸失眠、月經不調、崩漏、腎陰不足、精血虧虛。";
      description4.innerHTML ="熟地經九蒸九曬，補血力強，甚能填精，補血滋陰之方劑<b style ='color: #3a98a7'>四物湯</b>、<b style ='color: #3a98a7'>六味地黃丸</b>皆以其為君藥。而生地黃則為清熱涼血藥。";
   }
   else if(index === "DangGuei")
   {
      ...
      description4.innerHTML ="是補血能力也相當好的藥材，為婦科補血調經之要藥，亦在方劑<b style ='color: #40a5b4'>四物湯</b>中與熟地共同發揮補血之效用。此外潤腸通便的功效也是其一大特色。";
   }
   else if(index === "GouChi")
   {
      picture.src ="assets/img/medicine/GouChi.jpg";
      description1.innerHTML ="茄科植物枸杞或寧夏枸杞之乾燥成熟果實。";
      description2.innerHTML ="性味甘、平。歸肝、腎經。能補肝腎，而明目的功效為其特色。";
      description3.innerHTML ="為補陰藥，主治肝腎不足、腰酸遺精、頭暈目眩、視力減退、內障目昏、消渴。";
      description4.innerHTML ="枸杞補血補陰，入肝經，特別對症於肝血虛之目眩眼痠。如方劑<b style ='color: #40a5b4'>杞菊地黃丸</b>除滋陰外，添加的枸杞及菊花便為其帶來明目之效。";
   }
   else if(index === "BanSia")
   {
      picture.src ="assets/img/medicine/BanSia.jpg";
      description1.innerHTML ="天南星科植物半夏之乾燥塊莖。";
      description2.innerHTML ="性味辛、溫。具毒性。歸脾、胃、肺經。能燥濕化痰、降逆止嘔、消痞散結。";
      description3.innerHTML ="為祛痰藥，主治濕痰寒痰、胃氣上逆、心下痞、梅核氣。";
      description4.innerHTML ="與陳皮構成方劑<b style ='color: #40a5b4'>二陳湯</b>之基底，治一切痰濕。此藥有毒不可多服，然生薑能抑制其毒性，故常搭配使用。此外身燥者亦須慎用。";
   }
   else if(index === "RouGuei")
   {
      ...
      description4.innerHTML ="肉桂之樹皮作為溫裡藥，枝條 (桂枝) 則為辛溫解表藥。肉桂大熱動血，又會降低血壓，孕婦及低血壓者不宜。";
   }
   else if(index === "FuLing")
   {
      ...
      description2.innerHTML ="性味甘、淡、平。歸心、脾、腎經。能利水除濕、健脾安神。";
      description3.innerHTML ="為利水滲濕藥，主治脾虛水泛、各種水腫或水症。";
   ...
   else if(index === "ChuanSyong")
   {
      ...
      description4.innerHTML ="補氣、補血藥常搭配行氣、行血藥，方使補而不滯，如補血方劑<b style ='color: #40a5b4'>四物湯</b>裡便有川芎。而川芎活血行血，孕婦及月經過多者應慎用。";
   }
   else if(index === "SanChi")
   {
      ...
      description3.innerHTML ="為止血藥，主治跌打損傷、內外出血有瘀、缺血性腦血管病、血瘀型慢性肝炎。治內外出血證，以此單味內服外用即可奏效。";
      description4.innerHTML ="三七藥效卓著，止血不留瘀，化瘀不傷正，誠為傷科、血證要藥，又因生長時長，價值高昂。";
   }
   else if(index === "DaHuang")
   {
      ...
      description3.innerHTML ="為攻下藥，主治大便秘結、胃腸積滯、血熱妄行、熱毒瘡瘍。藉瀉下排除體內、腸內之濕熱。";
      description4.innerHTML ="運用方劑如<b style ='color: #40a5b4'>大承氣湯</b>，治熱病造成之燥屎內結、痞滿便秘。大黃為強瀉藥，脾胃虛者、婦女懷孕、經期、哺乳期忌用。";
   }
